...
# Original code from https://github.com/facebookresearch/detectron2/blob/main/detectron2/data/build.py
# Adapted from https://github.com/shahaf-arica/CuVLER/blob/main/cad/data/build.py
