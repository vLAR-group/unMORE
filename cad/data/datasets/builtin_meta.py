...
# Code Modified by Yafei Yang from https://github.com/shahaf-arica/CuVLER/blob/main/cad/data/datasets/builtin_meta.py
...
def _get_builtin_metadata(dataset_name):
    ...
    elif dataset_name in ["imagenet", "cross_domain", "lvis", "voc", "coco_cls_agnostic", "openimages", "coco_and_imagenet_cls_agnostic"]:
