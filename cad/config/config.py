...
# Original code from https://github.com/facebookresearch/CutLER/blob/main/cutler/config/cutler_config.py
# Modified by Yafei Yang from https://github.com/shahaf-arica/CuVLER/blob/main/cad/config/config.py
...
def add_cuvler_config(cfg):
    ...
    cfg.DATALOADER.IN_SINGLE_OBJECT = False
