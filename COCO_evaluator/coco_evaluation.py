...
try:
    ...
    # print('Use fast_eval_api')
except ImportError:
    print('Use pycocotools.cocoeval')
...
class COCOEvaluator(DatasetEvaluator):
    ...
    def __init__(
        ...
        *,
        ...
        with contextlib.redirect_stdout(io.StringIO()):
            self._coco_api = COCO(gt_annotation_path)
    ...
    def process(self, image_id, coco_instances):
        prediction = {
            "image_id": image_id,
    ...
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None):
        ...
        # print('precisions', coco_eval.eval["precision"].shape)
        # print('recalls', coco_eval.eval["recall"].shape)
        # print('counts', coco_eval.eval["counts"])
        # input()
        # print(coco_eval.keys())
        # input()
        results = {
